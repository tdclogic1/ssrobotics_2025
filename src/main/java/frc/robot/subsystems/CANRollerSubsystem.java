...
public class CANRollerSubsystem extends SubsystemBase {
  ...
  public Command runRoller(
    ...
    return Commands.run(
        () -> rollerMotor.set((forward.getAsDouble()*Constants.RollerConstants.ROLLER_POWER_SETTING) - (reverse.getAsDouble()*Constants.RollerConstants.ROLLER_POWER_SETTING)), rollerSubsystem);
  }
